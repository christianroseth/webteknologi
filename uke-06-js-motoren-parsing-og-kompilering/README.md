...
- [Ignition: An Interpreter for V8](https://v8.dev/blog/ignition-interpreter) — V8 Blog (erstatter Medium-artikkelen av Franziska Hinkelmann som er utilgjengelig bak paywall)
